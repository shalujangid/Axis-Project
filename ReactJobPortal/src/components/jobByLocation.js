...
class Location extends Component {
    ...
    componentDidMount(){
        ...
        var location=this.props.location.state.location_search
        ...
        return (
            <div style={{ backgroundColor: "#5F9EA0" }}>
                ...
                <div class='row'>
                    ...
                    <div class='col-sm'>
                        <br></br>
                        <h5><span style={{ fontWeight: "bold", color: 'white' }}>Result Matching Your Search For #&nbsp;{this.props.location.state.location_search}</span></h5>
