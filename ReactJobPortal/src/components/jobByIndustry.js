...
class Industry extends Component {
    ...
    componentDidMount() {
        var industry = this.props.location.state.industry_search
        UserService.getallJobpostByIndustry(industry).then((res) => {
            this.setState({
                jobpost: res.data
            });
        ...
        return (
            <div style={{ backgroundColor: "#5F9EA0" }}>
                ...
                <div class='row'>
                    ...
                    <div class='col-sm'>
                        <br></br>
                        <h5><span style={{ fontWeight: "bold", color: 'white' }}>Result Matching Your Search For #&nbsp;{this.props.location.state.industry_search}</span></h5>
