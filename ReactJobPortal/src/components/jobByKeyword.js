...
class Keyword extends Component {
    ...
    componentDidMount(){
        var keyword=this.props.location.state.keyword_search
        UserService.getallJobpostByKeyword(keyword).then((res) => {
            this.setState({
                jobpost: res.data
            });
        ...
        return (
            <div style={{ backgroundColor: "#5F9EA0" }}>
                ...
                <div class='row'>
                    ...
                    <div class='col-sm'>
                        <br></br>
                        <h5><span style={{ fontWeight: "bold", color: 'white' }}>Result Matching Your Search For #&nbsp;{this.props.location.state.keyword_search}</span></h5>
