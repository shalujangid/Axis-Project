...
class AddJobPost extends Component {
    ...
    addPost = (e) => {
        ...
        UserService.addpost(post).then((res) => {
            toast.success("Your Job Post is Added Successfully")
            setTimeout(() => {
                            ...
                            <div class="card">
                                ...
                                <div class="card-body ">
                                    <form>
                                        ...
                                        <button type="submit" onClick={this.addPost} class="btn btn-primary btn-block mb-4">
                                            Add Post
                                        </button>
                                    </form>
                                </div>
...
export default withRouter(AddJobPost);
